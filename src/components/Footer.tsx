      ...
      <div className="container mx-auto px-4">
          ...
          <div className="max-w-md">
            ...
            <form className="flex gap-2">
              <input
                ...
                className="flex-1 px-4 py-2 bg-dark-300 rounded-lg border border-white/10 text-white placeholder-gray-500 focus:outline-none focus:border-primary-500"
              />
              <button
                type="submit"
        ...
        <div className="py-6 border-t border-white/10 flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
          <div className="text-sm text-gray-400">
            © 2025 IntellijMind. All rights reserved.
          </div>
